...
manifypods : pure_all Table.pm
	@$(POD2MAN) \
	Table.pm \
	$(INST_MAN3DIR)/Data::Table.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/t.pl $(INST_LIBDIR)/Table.pm $(INST_LIBDIR)/t2.pl
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Data-Table\" VERSION=\"1,22,0,0\">\n}. qq{\t<TITLE>Data-Table</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Data-Table.ppd
